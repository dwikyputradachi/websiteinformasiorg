...
<div x-data="{ loading: true }" x-init="setTimeout(() => loading = false, 800)" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-2">
                Visualisasi hierarki dan tata kelola SDM di BUPA BP Batam.
            </p>
        </div>
    ...
    <!-- Card Container -->
    <!-- Hapus padding bawaan (p-6) di sini agar area scroll bisa lebih luas -->
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 relative min-h-[400px]">
        ...
        <div x-cloak x-show="!loading" 
            ...
            <!-- FIX TERPOTONG: Bungkus dengan w-max dan padding yang besar (p-10) -->
            <!-- mx-auto memastikan bagan tetap di tengah kalau layarnya kebesaran -->
